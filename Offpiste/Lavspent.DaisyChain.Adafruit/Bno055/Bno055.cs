...
//        private ISerial SerialPort { get; set; }
//        private IStream _stream;
//        private IGpio ResetPin { get; set; }
...
//        /// <returns>async Task</returns>
//        private async Task SendCommandAsync(byte[] command, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            if (command.Length != 0)
//            {
//                await _stream.WriteAsync(command, 0, command.Length, cancellationToken);
//            }
//        }

//        //public async Task<byte[]> LoadResponseAsync(uint length, CancellationToken cancellationToken = default(CancellationToken))
//        //{
...
//        /// <returns></returns>
//        private async Task<byte[]> ReadDataAsync(byte[] command, uint readLength, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            byte[] headerBuffer = new byte[2];
//            byte[] returnBuffer = new byte[readLength];

//            await SendCommandAsync(command, cancellationToken);
//            await _stream.ReadAsync(headerBuffer, 0, headerBuffer.Length, cancellationToken);
...
//            await _stream.ReadAsync(returnBuffer, 0, returnBuffer.Length, cancellationToken);
...
//        /// <returns></returns>
//        private async Task<byte[]> WriteDataAsync(byte[] command, bool ack = true, int retries = 5, CancellationToken cancellationToken = default(CancellationToken))
//        {
...
//                if (ack)
//                {
//                    await _stream.ReadAsync(ackBuffer, 0, ackBuffer.Length, cancellationToken);
...
//        private async Task WriteRegisterAsync(byte address, byte data, bool ack = true, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            byte[] writeBuffer = new byte[] { 0xAA, 0x00, address, 1, data };
//            byte[] response;
//            try
//            {
//                response = await WriteDataAsync(writeBuffer, ack, cancellationToken: cancellationToken);
//                if (ack)
//                {
...
//        private async Task<byte> ReadRegisterAsync(byte register, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            byte[] commandBuffer = new byte[] { 0xAA, 0x01, register, 1 };
//            byte[] readBuffer = new byte[1];
//            try
//            {
//                readBuffer = await ReadDataAsync(commandBuffer, 1, cancellationToken);
//            }
//            catch (Exception ex)
//            {
